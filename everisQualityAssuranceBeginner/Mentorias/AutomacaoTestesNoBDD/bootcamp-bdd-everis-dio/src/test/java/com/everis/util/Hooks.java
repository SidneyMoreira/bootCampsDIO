...
public class Hooks extends TestWatcher {
	...
	private static ATUTestRecorder gravar;
	...
	@After
	public void afterCenario() throws IOException, ATUTestRecorderException{
	...
	public static void navigateToULRChrome(String url) throws ATUTestRecorderException{
		...
		Date date = new Date();
		gravar = new ATUTestRecorder("src/test/", "Desafio_Everis_BDD"+dateFormat.format(date),false);
		gravar.start();
